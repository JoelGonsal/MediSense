...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? MainCopyWidget() : SignUpWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: MainCopyWidget.routeName,
          path: MainCopyWidget.routePath,
        ...
        FFRoute(
          name: PillRecommendWidget.routeName,
          path: PillRecommendWidget.routePath,
          builder: (context, params) => PillRecommendWidget(),
        ),
        FFRoute(
          name: PillRec2Widget.routeName,
          path: PillRec2Widget.routePath,
          builder: (context, params) => PillRec2Widget(
        ...
        FFRoute(
          name: IdentificationWidget.routeName,
          path: IdentificationWidget.routePath,
        ...
        FFRoute(
          name: ChatbotCopyWidget.routeName,
          path: ChatbotCopyWidget.routePath,
          builder: (context, params) => ChatbotCopyWidget(),
        ),
        FFRoute(
          name: SkinDiseaseWidget.routeName,
          path: SkinDiseaseWidget.routePath,
          builder: (context, params) => SkinDiseaseWidget(),
        ),
        FFRoute(
          name: DiseaseMainPageWidget.routeName,
          path: DiseaseMainPageWidget.routePath,
          builder: (context, params) => DiseaseMainPageWidget(),
        ),
        FFRoute(
          name: DiabetesWidget.routeName,
          path: DiabetesWidget.routePath,
          builder: (context, params) => DiabetesWidget(),
        ),
        FFRoute(
          name: BreathingExerciseWidget.routeName,
          path: BreathingExerciseWidget.routePath,
          builder: (context, params) => BreathingExerciseWidget(),
        ),
        FFRoute(
