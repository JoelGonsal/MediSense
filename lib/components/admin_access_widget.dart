...
export 'admin_access_model.dart';
...
class _AdminAccessWidgetState extends State<AdminAccessWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminAccessModel());
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                FFLocalizations.of(context).getText(
                  '5kww8vzn' /* You are not authorized to acce... */,
                ),
                textAlign: TextAlign.center,
