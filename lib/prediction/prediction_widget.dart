...
class _PredictionWidgetState extends State<PredictionWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultgod = await SymptomsNamesCall.call();

      if ((_model.apiResultgod?.succeeded ?? true)) {
        FFAppState().PostData1 = getJsonField(
          (_model.apiResultgod?.jsonBody ?? ''),
          r'''$''',
          true,
        )!
            .toList()
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FutureBuilder<ApiCallResponse>(
                                  future: _model.symp1(
                                    requestFn: () => SymptomsNamesCall.call(),
                                  ),
                          ...
                          builder: (context) => FFButtonWidget(
                            onPressed: () async {
                              if ((_model.dropDownValue1 != null &&
                                ...
                                _model.apiResultg2i =
                                    await DiseasePredictionCall.call(
                                ...
                                if ((_model.apiResultg2i?.succeeded ?? true)) {
                                  FFAppState().PostData1 = getJsonField(
                                    (_model.apiResultg2i?.jsonBody ?? ''),
                                    r'''$''',
                                    true,
                                  )!
                                      .toList()
